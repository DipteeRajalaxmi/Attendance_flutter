      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios_new_rounded,
              size: 18, color: Color(0xFF4A4B65)),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Use your company email and the invite code sent by your admin',
                style: TextStyle(fontSize: 15, color: Color(0xFF8B8FA8)),
              ),
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon:
                Icon(icon, size: 20, color: const Color(0xFF8B8FA8)),
